...
void kxnet::net::defaultConnectionCallback(const TcpConnectionPtr& conn)
{
...
void kxnet::net::defaultMessageCallback(const TcpConnectionPtr&,
                                        Buffer* buf,
                                        Timestamp)
{
  buf->retrieveAll();
